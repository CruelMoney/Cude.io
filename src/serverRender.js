    ...
    return renderToString(
       <html lang="en">
        <head>
          ...
          <meta name="apple-mobile-web-app-title" content="CUDE"/>
          <meta name="application-name" content="CUDE"/>
